                    ...
                    <form method="POST" action="/slider/{{ $slider->id }}">
                        ...
                        <div class="logo-content">
                            <div class="logo-wrapper d-flex justify-content-center">
                                <img src="{{ url('/').$slider->media->image_path }}" alt="Logo Placeholder">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select class="form-control" id="store" name="store_id">
                                    <option value="{{ $slider->store_id }}">{{ $slider->store->name }}</option>
                                    @foreach( $slider->stores as $store )
                                        @if( $store->id !== $slider->store_id )
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" autocomplete="description" autofocus value="{{ $slider->description }}">
                                @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
